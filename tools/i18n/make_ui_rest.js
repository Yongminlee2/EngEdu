...
// ---------- 영어 전용 키 ----------
// ⚠ ui_rest.js 는 이 스크립트가 통째로 다시 쓴다. 새 키는 반드시 **여기**에 넣을 것 —
//    ui_rest.js 를 직접 고치면 다음 생성 때 조용히 사라진다 (실제로 한 번 날렸다).
//    여기는 백틱 템플릿이라 줄바꿈은 역슬래시를 두 번 써야 한다.
...
play_paid_left: { ko:"오늘 용돈 받을 수 있는 판: %1$d판 남음", en:"Games that still pay today: %1$d left", ja:"きょう おこづかいが もらえる かず: のこり %1$d かい", zh:"今天还能拿零花钱的局数: 还剩 %1$d 局", es:"Partidas que aún dan dinero hoy: quedan %1$d", fr:"Parties qui rapportent encore aujourd'hui : %1$d", de:"Spiele mit Taschengeld heute: noch %1$d", pt:"Partidas que ainda pagam hoje: faltam %1$d", ru:"Игр с карманными сегодня: осталось %1$d", vi:"Số ván còn được thưởng hôm nay: %1$d", th:"เกมที่ยังได้เงินวันนี้: เหลือ %1$d ตา", in:"Permainan berhadiah hari ini: sisa %1$d" },
game_q_balloon: { ko:"%1$s 를 찾아 터뜨려요!", en:"Pop the %1$s balloon!", ja:"%1$s を さがして わろう!", zh:"找到 %1$s 并戳破!", es:"¡Explota el globo de %1$s!", fr:"Éclate le ballon %1$s !", de:"Platze den %1$s-Ballon!", pt:"Estoure o balão de %1$s!", ru:"Лопни шарик «%1$s»!", vi:"Tìm và bắn quả bóng %1$s!", th:"หาและเจาะลูกโป่ง %1$s!", in:"Pecahkan balon %1$s!" },
game_q_basket: { ko:"%1$s 를 %2$s 개 담아요", en:"Put %2$s %1$s in the basket", ja:"%1$s を %2$s こ いれよう", zh:"把 %2$s 个 %1$s 装进去", es:"Mete %2$s %1$s en la cesta", fr:"Mets %2$s %1$s dans le panier", de:"Leg %2$s %1$s in den Korb", pt:"Coloque %2$s %1$s na cesta", ru:"Положи %2$s «%1$s» в корзину", vi:"Bỏ %2$s %1$s vào giỏ", th:"ใส่ %1$s จำนวน %2$s ชิ้น", in:"Masukkan %2$s %1$s ke keranjang" },
tr_praise_1: { ko:"잘했어요! 🎉", en:"Well done! 🎉", ja:"よく できました! 🎉", zh:"做得好! 🎉", es:"¡Muy bien! 🎉", fr:"Bien joué ! 🎉", de:"Gut gemacht! 🎉", pt:"Muito bem! 🎉", ru:"Молодец! 🎉", vi:"Giỏi lắm! 🎉", th:"เก่งมาก! 🎉", in:"Bagus sekali! 🎉" },
tr_praise_2: { ko:"완벽해요! 🌟", en:"Perfect! 🌟", ja:"かんぺき! 🌟", zh:"完美! 🌟", es:"¡Perfecto! 🌟", fr:"Parfait ! 🌟", de:"Perfekt! 🌟", pt:"Perfeito! 🌟", ru:"Идеально! 🌟", vi:"Hoàn hảo! 🌟", th:"เพอร์เฟกต์! 🌟", in:"Sempurna! 🌟" },
tr_praise_3: { ko:"삐약! 최고예요!", en:"Peep! You're the best!", ja:"ピヨ! さいこう!", zh:"叽叽! 你最棒!", es:"¡Pío! ¡Eres el mejor!", fr:"Cui-cui ! Tu es le meilleur !", de:"Piep! Du bist super!", pt:"Piu! Você é demais!", ru:"Пи-пи! Ты лучший!", vi:"Chíp! Bạn giỏi nhất!", th:"จิ๊บ! เยี่ยมที่สุด!", in:"Ciap! Kamu hebat!" },
tr_praise_4: { ko:"멋져요! 👏", en:"Awesome! 👏", ja:"すてき! 👏", zh:"太棒了! 👏", es:"¡Genial! 👏", fr:"Super ! 👏", de:"Klasse! 👏", pt:"Incrível! 👏", ru:"Отлично! 👏", vi:"Tuyệt vời! 👏", th:"เยี่ยม! 👏", in:"Keren! 👏" },
tr_praise_5: { ko:"우와, 예쁘게 썼네요!", en:"Wow, that's beautiful writing!", ja:"わあ、きれいに かけたね!", zh:"哇，写得真漂亮!", es:"¡Guau, qué bonita letra!", fr:"Waouh, quelle belle écriture !", de:"Wow, so schön geschrieben!", pt:"Uau, que letra bonita!", ru:"Ух ты, как красиво написано!", vi:"Ồ, viết đẹp quá!", th:"ว้าว เขียนสวยจัง!", in:"Wah, tulisannya bagus!" },
tr_off_path: { ko:"앗, 길을 벗어났어요. 다시 천천히! 🐥", en:"Oops, off the path. Try again slowly! 🐥", ja:"あっ、みちを はずれたよ。ゆっくり もういちど! 🐥", zh:"哎呀，出线了。慢慢再来一次! 🐥", es:"¡Ups, te saliste! Inténtalo despacio 🐥", fr:"Oups, tu es sorti du chemin. Recommence doucement ! 🐥", de:"Ups, vom Weg abgekommen. Nochmal langsam! 🐥", pt:"Opa, saiu do caminho. Tente devagar! 🐥", ru:"Ой, сбился с линии. Попробуй медленно! 🐥", vi:"Ối, lệch khỏi đường rồi. Thử lại chậm thôi! 🐥", th:"อุ๊ย ออกนอกเส้นแล้ว ลองช้า ๆ อีกครั้ง! 🐥", in:"Ups, keluar jalur. Coba pelan-pelan lagi! 🐥" },
tr_case_upper: { ko:"대문자", en:"uppercase", ja:"おおもじ", zh:"大写", es:"mayúscula", fr:"majuscule", de:"Großbuchstabe", pt:"maiúscula", ru:"заглавная", vi:"chữ hoa", th:"ตัวพิมพ์ใหญ่", in:"huruf besar" },
tr_case_lower: { ko:"소문자", en:"lowercase", ja:"こもじ", zh:"小写", es:"minúscula", fr:"minuscule", de:"Kleinbuchstabe", pt:"minúscula", ru:"строчная", vi:"chữ thường", th:"ตัวพิมพ์เล็ก", in:"huruf kecil" },
tr_written_n: { ko:"지금까지 %1$d번 썼어요. 또 써 볼까요? ✏️", en:"You've written it %1$d times. Write it again? ✏️", ja:"いままで %1$d かい かいたよ。もういちど かく? ✏️", zh:"已经写了 %1$d 次。再写一次吗? ✏️", es:"Lo has escrito %1$d veces. ¿Otra vez? ✏️", fr:"Tu l'as écrit %1$d fois. Encore une fois ? ✏️", de:"Du hast es %1$d Mal geschrieben. Noch mal? ✏️", pt:"Você escreveu %1$d vezes. Escrever de novo? ✏️", ru:"Ты написал это %1$d раз. Ещё раз? ✏️", vi:"Bạn đã viết %1$d lần. Viết nữa nhé? ✏️", th:"เขียนไปแล้ว %1$d ครั้ง เขียนอีกไหม? ✏️", in:"Sudah ditulis %1$d kali. Tulis lagi? ✏️" },
tr_stroke_of: { ko:"%1$d / %2$d 획", en:"Stroke %1$d / %2$d", ja:"%1$d / %2$d かくめ", zh:"第 %1$d / %2$d 笔", es:"Trazo %1$d / %2$d", fr:"Trait %1$d / %2$d", de:"Strich %1$d / %2$d", pt:"Traço %1$d / %2$d", ru:"Черта %1$d / %2$d", vi:"Nét %1$d / %2$d", th:"เส้นที่ %1$d / %2$d", in:"Goresan %1$d / %2$d" },
tr_stroke_done: { ko:"%1$d / %1$d 획 ✅", en:"Stroke %1$d / %1$d ✅", ja:"%1$d / %1$d かく ✅", zh:"第 %1$d / %1$d 笔 ✅", es:"Trazo %1$d / %1$d ✅", fr:"Trait %1$d / %1$d ✅", de:"Strich %1$d / %1$d ✅", pt:"Traço %1$d / %1$d ✅", ru:"Черта %1$d / %1$d ✅", vi:"Nét %1$d / %1$d ✅", th:"เส้นที่ %1$d / %1$d ✅", in:"Goresan %1$d / %1$d ✅" },
tr_next_stroke: { ko:"좋아요! 다음은 %1$d번 획이에요 ✏️", en:"Nice! Now stroke %1$d ✏️", ja:"いいね! つぎは %1$d かくめ ✏️", zh:"很好! 接下来是第 %1$d 笔 ✏️", es:"¡Bien! Ahora el trazo %1$d ✏️", fr:"Bien ! Maintenant le trait %1$d ✏️", de:"Gut! Jetzt Strich %1$d ✏️", pt:"Boa! Agora o traço %1$d ✏️", ru:"Отлично! Теперь черта %1$d ✏️", vi:"Tốt! Giờ đến nét %1$d ✏️", th:"ดีมาก! ต่อไปเส้นที่ %1$d ✏️", in:"Bagus! Sekarang goresan %1$d ✏️" },
tr_done_msg: { ko:"%1$s\\n%2$s  %3$d번 썼어요!", en:"%1$s\\n%2$s  Written %3$d times!", ja:"%1$s\\n%2$s  %3$d かい かいたよ!", zh:"%1$s\\n%2$s  写了 %3$d 次!", es:"%1$s\\n%2$s  ¡Escrito %3$d veces!", fr:"%1$s\\n%2$s  Écrit %3$d fois !", de:"%1$s\\n%2$s  %3$d Mal geschrieben!", pt:"%1$s\\n%2$s  Escrito %3$d vezes!", ru:"%1$s\\n%2$s  Написано %3$d раз!", vi:"%1$s\\n%2$s  Đã viết %3$d lần!", th:"%1$s\\n%2$s  เขียนไป %3$d ครั้ง!", in:"%1$s\\n%2$s  Ditulis %3$d kali!" },
tr_done_coins: { ko:"완성! 용돈 +%1$s 🎁  · '한 번 더 쓰기'로 연습해요!", en:"Done! +%1$s 🎁  · Tap 'Write again' to practice!", ja:"かんせい! おこづかい +%1$s 🎁  · 「もういちど かく」で れんしゅう!", zh:"完成! 零花钱 +%1$s 🎁  · 点「再写一次」继续练习!", es:"¡Listo! +%1$s 🎁  · ¡Pulsa «Escribir otra vez»!", fr:"Terminé ! +%1$s 🎁  · Appuie sur « Écrire encore » !", de:"Fertig! +%1$s 🎁  · Tippe auf „Nochmal schreiben“!", pt:"Pronto! +%1$s 🎁  · Toque em «Escrever de novo»!", ru:"Готово! +%1$s 🎁  · Нажми «Написать ещё раз»!", vi:"Xong! +%1$s 🎁  · Bấm «Viết lại» để luyện thêm!", th:"เสร็จแล้ว! +%1$s 🎁  · กด «เขียนอีกครั้ง» เพื่อฝึกต่อ!", in:"Selesai! +%1$s 🎁  · Tekan «Tulis lagi» untuk latihan!" },
tr_done_more: { ko:"완성! 한 번 더 써 볼까요? ✏️", en:"Done! Want to write it again? ✏️", ja:"かんせい! もういちど かいてみる? ✏️", zh:"完成! 再写一次好吗? ✏️", es:"¡Listo! ¿Lo escribes otra vez? ✏️", fr:"Terminé ! Tu l'écris encore ? ✏️", de:"Fertig! Noch mal schreiben? ✏️", pt:"Pronto! Quer escrever de novo? ✏️", ru:"Готово! Напишешь ещё раз? ✏️", vi:"Xong! Viết lại lần nữa nhé? ✏️", th:"เสร็จแล้ว! เขียนอีกครั้งไหม? ✏️", in:"Selesai! Mau tulis lagi? ✏️" },
tr_done_many: { ko:"이 글자는 %1$d번이나 썼어요! 정말 잘하네요 🌟", en:"You've written this letter %1$d times! Amazing 🌟", ja:"この もじを %1$d かいも かいたよ! すごい 🌟", zh:"这个字母写了 %1$d 次! 真厉害 🌟", es:"¡Has escrito esta letra %1$d veces! Increíble 🌟", fr:"Tu as écrit cette lettre %1$d fois ! Bravo 🌟", de:"Du hast diesen Buchstaben %1$d Mal geschrieben! Toll 🌟", pt:"Você escreveu esta letra %1$d vezes! Incrível 🌟", ru:"Ты написал эту букву %1$d раз! Здорово 🌟", vi:"Bạn đã viết chữ này %1$d lần! Giỏi quá 🌟", th:"เขียนตัวนี้ไป %1$d ครั้งแล้ว! เก่งมาก 🌟", in:"Huruf ini sudah ditulis %1$d kali! Hebat 🌟" },
tr_write_again: { ko:"✏️ 한 번 더 쓰기", en:"✏️ Write again", ja:"✏️ もういちど かく", zh:"✏️ 再写一次", es:"✏️ Escribir otra vez", fr:"✏️ Écrire encore", de:"✏️ Nochmal schreiben", pt:"✏️ Escrever de novo", ru:"✏️ Написать ещё раз", vi:"✏️ Viết lại", th:"✏️ เขียนอีกครั้ง", in:"✏️ Tulis lagi" },
tr_first_write: { ko:"%1$s 처음 쓰기", en:"%1$s first write", ja:"%1$s はじめて かいた", zh:"%1$s 第一次书写", es:"%1$s primera escritura", fr:"%1$s première écriture", de:"%1$s erstes Schreiben", pt:"%1$s primeira escrita", ru:"%1$s первое письмо", vi:"%1$s viết lần đầu", th:"%1$s เขียนครั้งแรก", in:"%1$s tulisan pertama" },
tr_nth_write: { ko:"%1$s %2$d번째 쓰기", en:"%1$s write #%2$d", ja:"%1$s %2$d かいめ", zh:"%1$s 第 %2$d 次书写", es:"%1$s escritura n.º %2$d", fr:"%1$s écriture n° %2$d", de:"%1$s Schreiben Nr. %2$d", pt:"%1$s escrita nº %2$d", ru:"%1$s письмо №%2$d", vi:"%1$s lần viết thứ %2$d", th:"%1$s การเขียนครั้งที่ %2$d", in:"%1$s tulisan ke-%2$d" },
tr_times: { ko:"%1$s %2$d번", en:"%1$s ×%2$d", ja:"%1$s %2$dかい", zh:"%1$s %2$d次", es:"%1$s ×%2$d", fr:"%1$s ×%2$d", de:"%1$s ×%2$d", pt:"%1$s ×%2$d", ru:"%1$s ×%2$d", vi:"%1$s ×%2$d", th:"%1$s %2$d ครั้ง", in:"%1$s ×%2$d" },
...
ly_about: { ko:"삐약영어 🐥 나만의 영어 공부 앱\\n말하기 채점은 인터넷이 있을 때 더 정확해요", en:"Peep English 🐥 your very own English study app\\nSpeaking scores are more accurate with internet", ja:"ピープえいご 🐥 じぶんだけの えいご アプリ\\nスピーキングの さいてんは インターネットが あると せいかく", zh:"啾啾英语 🐥 属于你的英语学习应用\\n有网络时口语评分更准确", es:"Peep English 🐥 tu propia app de inglés\\nLa nota de habla es más precisa con internet", fr:"Peep English 🐥 ton appli d'anglais à toi\\nLa note d'oral est plus précise avec internet", de:"Peep English 🐥 deine eigene Englisch-App\\nSprechbewertung ist mit Internet genauer", pt:"Peep English 🐥 seu app de inglês\\nA nota de fala é mais precisa com internet", ru:"Peep English 🐥 твоё приложение для английского\\nОценка речи точнее с интернетом", vi:"Peep English 🐥 ứng dụng tiếng Anh của riêng bạn\\nChấm nói chính xác hơn khi có mạng", th:"Peep English 🐥 แอปเรียนอังกฤษของคุณ\\nการให้คะแนนพูดแม่นยำขึ้นเมื่อมีเน็ต", in:"Peep English 🐥 aplikasi belajar Inggrismu\\nPenilaian bicara lebih akurat dengan internet" },
