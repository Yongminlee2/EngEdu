...
Object.assign(module.exports.strings, require("./ui_lesson"), require("./ui_en_lesson"), require("./ui_result"), require("./ui_skills"), require("./ui_home"), require("./ui_stage"), require("./ui_wallet"), require("./ui_rest"));
